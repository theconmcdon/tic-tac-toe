...
//appropriate amount for the tic tac toes projects that didn't make it
...
//value of 1, which is the same as all draw boards
...
//the novel coronavirus kills the current game by resetting all board values back to 0 so that
//the Gamma Checker can't complete the draw scenario as explained previously 
//i probably could've just thrown a boolean in another function and mostly avoided this part 
//but i felt like this piece was helpful for debugging and testing while building and i think 
//i can continue to add values to reset to it in order to make the game run more smoothly in
//a future build and keep track of scores and other stuff
