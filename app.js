...
let newGameButton = document.querySelectorAll('.button');
...
//so that the Gamma Checker can't complete the draw scenario as explained previously and players cant make move after the game is over
